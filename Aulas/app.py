print('Hello World!', end='')#nao quebra linha, continua com "Qual seu nome?"
...
print(a.isnumeric())#retornar com TRUE ou FALSE se o valor de a(linha 5) for numero.
print(a.isalpha())#Retorna TRUE ou FALSE se o valor é letra
print(a.isalnum())#Retorna se a é alfanumerico  

print ('Divisao em float é {:.3f}'.format(s))#resultado floar até 3 casas decimais
...
print (x%y, 'resto da divisoa')#o bom e velho resto de divisao, para saber se o numero é primo
...
print('Bem vindo {:>20} .' .format(nome))#nome ocupa 20 char porém todo a direita
print('Bem vindo {:<20} .' .format(nome))#nome ocupa 20 char mas todo a esquerda
print('Bem vindo {:^20} .' .format(nome))#nome ocupa 20 char mas centralizado
print('Bem vindo {:=^20} .' .format(nome))#nome ocupa 20 char porém centralizado e com = preenchidos nos vazios